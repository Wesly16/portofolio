      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            <br /> I am highly motivated to learn new experiences, enjoy activities that involve a lot of people or teamwork And have an interest in web programming and data science.
            <br />
